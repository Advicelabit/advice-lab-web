        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8">
              Professional financial management services to keep your practice running smoothly.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Our experienced accountants and bookkeepers ensure your financial records are accurate, up-to-date, and compliant.
              </p>
      ...
      <section className="py-24 bg-secondary">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let us handle your accounting so you can focus on growing your practice.
          </p>
