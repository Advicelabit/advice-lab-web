...
const services = [
  {
    icon: FileText,
    title: "Paraplanning & Admin",
    description: "Comprehensive support for financial planning documentation and client administration.",
    features: [
  ...
  },
  {
    ...
    description: "Professional bookkeeping and financial reporting services for advisory practices.",
    features: [
      "Daily bookkeeping",
      "Financial reporting",
      "BAS preparation",
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <ScrollAnimation animation="fade-up">
            ...
            <p className="text-lg sm:text-xl text-primary-foreground/80 max-w-3xl mx-auto">
              Expert offshore support tailored to Australian financial advisory practices.
            </p>
          </ScrollAnimation>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid gap-10 md:gap-14 lg:gap-16">
            {services.map((service, index) => (
              ...
              >
                <ScrollAnimation animation={index % 2 === 0 ? "fade-right" : "fade-left"}>
                  <div className={`${index % 2 === 1 ? "lg:order-2" : ""} text-center md:text-left`}>
                    ...
                    <Button asChild className="hover:scale-105 transition-transform w-full sm:w-auto justify-center">
                ...
                <ScrollAnimation animation={index % 2 === 0 ? "fade-left" : "fade-right"} delay={200}>
